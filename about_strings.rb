...
It was the worst of times.
EOS
    assert_equal 53, long_string.size       #if we do like this then we can handle multiple lines without adding white space
  end
  ...
  in_ruby_version("1.9") do
    def test_in_ruby_1_9_single_characters_are_represented_by_strings
      assert_equal "a", ?a
      assert_equal false, ?a == 97     #TODO Not clear
    end
  end
